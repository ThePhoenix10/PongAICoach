        ...
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <nav aria-labelledby="footer-product">
            ...
            <ul className="mt-4 space-y-3 text-sm">
              ...
              {ready && user ? (
                <li>
                  <Link href="/dashboard/" className="text-slate-500 hover:text-orange-600 transition-colors">My Videos</Link>
                </li>
              ) : (
                <li>
                  <Link href="/signin/?next=/dashboard/" className="text-slate-500 hover:text-orange-600 transition-colors">My Videos</Link>
                </li>
              )}
              <li>
                <Link href="/analysis/game_1/" className="text-slate-500 hover:text-orange-600 transition-colors">Demo Video</Link>
              </li>
              <li>
                <Link href="/how-it-works/" className="text-slate-500 hover:text-orange-600 transition-colors">How it works</Link>
              </li>
              <li>
                <Link href="/about/" className="text-slate-500 hover:text-orange-600 transition-colors">About Us</Link>
              </li>
            </ul>
          </nav>
